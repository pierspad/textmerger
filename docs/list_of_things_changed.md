...
- **Pannello app settings**: Aggiunto nella sidebar impostazioni un riquadro informativo con nome app, versione cliccabile verso la release GitHub, stack, licenza, link al repository e link autore `pierspad`.
...
- **Controllo Cargo.lock**: Estesa la verifica versioni a `textmerger/src-tauri/Cargo.lock` e aggiunta la sincronizzazione automatica del lock durante `update_project_info.sh`.
