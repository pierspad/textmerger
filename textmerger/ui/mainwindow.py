...
from utils.constants import (BORDER_COLOR, DARK_BG, DARKER_BG, LIGHT_BG,
                             LIGHT_BORDER_COLOR, LIGHT_PRIMARY_COLOR,
                             LIGHT_SECONDARY_COLOR, LIGHT_TEXT_COLOR,
                             LIGHTER_BG, MIN_WINDOW_HEIGHT, MIN_WINDOW_WIDTH,
                             PRIMARY_COLOR, SECONDARY_COLOR, TEXT_COLOR,
                             WINDOW_HEIGHT_PERCENTAGE, WINDOW_WIDTH_PERCENTAGE)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.text_page = None
        self.hide_ipynb_outputs = True  # Default a True (nasconde gli output)
    ...
    def init_ui(self):
        ...
        self.ipynb_toggle_button.setChecked(True)  # Default a True (nasconde gli output)
    ...
    def closeEvent(self, event):
        # Processa gli eventi in sospeso per mostrare immediatamente il dialogo
        QApplication.processEvents()
        ...
        # Imposta Yes come pulsante predefinito per premere Invio
